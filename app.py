                ...
                if not result_p.empty:
                    ...
                    if not is_terminated:
                        ...
                        for index, row in result_p.iterrows():
                            ...
                            st.warning(
                                f"""
                            **무단결석 횟수:** {penalty_count}<br>
                            **무단결석 일자:** {absent_date}<br>
                            **패널티:** {penalty_date}<br>
                            """,
                        ...
                        with st.expander("🚨 무단결석 및 패널티 규정", expanded=False):
                            ...
                            **무단결석 1회당 → 패널티 봉사 2회 (익월 진행)**
                            ...
                            &nbsp;&nbsp; _ex) 10월 1일 결석 → 패널티 봉사 11월 1일, 2일 진행_
                            
                            * ✅ **패널티 봉사 2회 이행 시:** 2회차 시간만 인정
                              \n&nbsp;&nbsp;&nbsp;&nbsp; _ex) 11월 1일, 2일 모두 진행 O → 11월 2일 봉사시간만 지급_
                            
                            * ⚠️ **패널티 봉사 1회 결석 시:** 출석 1회 봉사시간 미지급
                              \n&nbsp;&nbsp;&nbsp;&nbsp; _ex) 11월 1일 이행, 2일 결석 → 11월 1일 봉사시간 미지급_
                            
                            * ❌ **패널티 봉사 2회 결석 시:** 무단결석 횟수 추가
                            
                            * **참고:** 패널티 봉사 미이행에 따른 2차 패널티 봉사는 없습니다.
                            """)
